...
htmlhelp_basename = 'VTKPythonPackagedoc'
...
latex_documents = [
    (master_doc, 'VTKPythonPackage.tex', u'VTKPythonPackage Documentation',
...
man_pages = [
    (master_doc, 'vtkpythonpackage', u'VTKPythonPackage Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'VTKPythonPackage', u'VTKPythonPackage Documentation',
     author, 'VTKPythonPackage', 'One line description of project.',
     'Miscellaneous'),
]
